...
<body>
    ...
    <main class="contenedor seccion">
        ...
        <form class="formulario" action="controlador/registro_clientes.php" method="POST">
            <fieldset>
            ...
            <fieldset>
                ...
                <select id="opciones" name="tipo_operacion">
            ...
            <fieldset>
                ...
                <div class="forma-contacto">
                    ...
                    <input name="metodo_contacto" type="radio" value="telefono" id="contactar-telefono">

                    <label for="contactar-email">E-mail</label>
                    <input name="metodo_contacto" type="radio" value="email" id="contactar-email">
                </div>
                ...
                <input type="time" id="hora" name="hora_contacto" min="09:00" max="18:00">
    ...
    <footer class="footer seccion">
        <div class="contenedor contenedor-footer">
            <nav class="navegacion">
                ...
                <a href="anuncios.html">Anuncios</a>
                <a href="blog.html">Blog</a>
                <a href="contacto.phpss">Contacto</a>
            </nav>
        </div>
